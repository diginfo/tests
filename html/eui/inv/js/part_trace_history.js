...
$('#pth').datagrid({
  ...
  columns: [[
      ...
      {field:"WOREF_IN", title:"In WOREF", width:120, fixed:true,formatter:dwap.page.docref},
      ...
      {field:"WOREF_OUT", title:"Out WOREF", width:120, fixed:true,formatter:dwap.page.docref},
    ]]
  ,
  onLoadSuccess:function(data){
   // console.log(data)
